               ...
               switch (dataType)
               {
                  ...
                  case IFCDataPrimitiveType.Double:
                     if (propertyValueToUse.IFCUnit != null)
                        unitType = propertyValueToUse.IFCUnit.Spec;
                     else
         ...
         if (existingParameter == null)
         {
            ...
            switch (dataType)
            {
               ...
               case IFCDataPrimitiveType.Logical:
                  ...
                  break;
               case IFCDataPrimitiveType.Double:
                  created = IFCPropertySet.AddParameterDouble(doc, element, category, parameterName, unitType, doubleValueToUse.Value, Id);
                  break;
