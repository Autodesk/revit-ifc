...
namespace Revit.IFC.Import.Data
{
   ...
   public class IFCDistributionSystem : IFCSystem
   {
      ...
      /// <summary>
      /// Creates an Element for the IFCDistributionSystem.
      /// This also duplicates the Geometry from all Related Objects to use for this Element.
      /// </summary>
      /// <param name="doc">Document into which new Element is placed.</param>
      protected override void Create(Document doc)
      {
         ...
         DirectShape distributedSystemElement = IFCElementUtil.CreateElement(doc, CategoryId, GlobalId, geometryObjects, Id, EntityType);
         if (distributedSystemElement != null)
         {
            CreatedElementId = distributedSystemElement.Id;
