...
namespace Revit.IFC.Export.Utility
{
   ...
   public class LevelInfoCache
   {
      ...
      public void AddLevelInfo(ExporterIFC exporterIFC, Level level, IFCLevelInfo info, bool isBaseBuildingStorey)
      {
         if (level == null)
         {
            return;
      ...
      public void AddLevelRemapping(ExporterIFC exporterIFC, Level level)
      {
         if (level == null)
            return;

         ElementId overrideLevelId = ParameterUtil.OverrideContainmentParameter(exporterIFC, level, out _);
      ...
      {
         if (!exporterIFC.GetLevelInfos().TryGetValue(levelId, out IFCLevelInfo levelInfo))
            return null;
         return levelInfo;
      }
