...
{
   /// <summary>
   /// A calculation class to calculate the lining depth of a window or door.
   /// </summary>
   class LiningDepthCalculator : PropertyCalculator
   {
      /// <summary>
      /// A double variable to keep the calculated value.
      /// </summary>
      private double m_LiningDepth = 0.0;

      /// <summary>
      /// The LiningDepthCalculator instance.
      /// </summary>
      public static LiningDepthCalculator Instance { get; } = new LiningDepthCalculator();
      ...
      public override bool Calculate(ExporterIFC exporterIFC, IFCAnyHandle handle, IFCExportBodyParams extrusionCreationData, Element element, ElementType elementType, EntryMap entryMap)
      {
         ...
         const string parameterNameV1 = "LiningDepth";
         string parameterNameV2 = typeName + "LiningProperties.LiningDepth";
         string parameterNameV3 = "Pset_" + baseTypeName + "LiningProperties.LiningDepth";
         ...
         if (value.HasValue)
         {
            m_LiningDepth = UnitUtil.ScaleLength(value.Value);
            return true;
         }
