...
namespace Revit.IFC.Export.Exporter.PropertySet.Calculators
{
   class ConcealedFlooringCalculator : PropertyCalculator
   {
      ...
      {
         int? concealedFlooring = ParameterUtil.GetIntValueFromElementOrSymbol(element, entryMap.RevitParameterName);
         if (!concealedFlooring.HasValue)
            concealedFlooring = ParameterUtil.GetIntValueFromElementOrSymbol(element, entryMap.CompatibleRevitParameterName);
         if (!concealedFlooring.HasValue)
            return false;
