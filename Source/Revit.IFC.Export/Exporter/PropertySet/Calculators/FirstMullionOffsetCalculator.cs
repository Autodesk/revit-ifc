...
{
   /// <summary>
   /// A calculation class to calculate the first mullion offset of a window.
   /// </summary>
   class FirstMullionOffsetCalculator : PropertyCalculator
   {
      /// <summary>
      /// A double variable to keep the calculated value.
      /// </summary>
      private double m_FirstMullionOffset = 0.0;

      /// <summary>
      /// The FirstMullionOffsetCalculator instance.
      /// </summary>
      public static FirstMullionOffsetCalculator Instance { get; } = new FirstMullionOffsetCalculator();
      ...
      {
         const string parameterNameV1 = "FirstMullionOffset";
         const string parameterNameV2 = "IfcWindowLiningProperties.FirstMullionOffset";
         const string parameterNameV3 = "Pset_WindowLiningProperties.FirstMullionOffset";
         ...
         {
            m_FirstMullionOffset = System.Math.Clamp(value.Value, 0.0, 1.0);
            return true;
         }
