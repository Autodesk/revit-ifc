...
{
   /// <summary>
   /// A calculation class to calculate the second transom offset of a window.
   /// </summary>
   class SecondTransomOffsetCalculator : PropertyCalculator
   {
      /// <summary>
      /// A double variable to keep the calculated value.
      /// </summary>
      private double m_SecondTransomOffset = 0.0;

      /// <summary>
      /// The SecondTransomOffsetCalculator instance.
      /// </summary>
      public static SecondTransomOffsetCalculator Instance { get; } = new SecondTransomOffsetCalculator();
      ...
      {
         const string parameterNameV1 = "SecondTransomOffset";
         const string parameterNameV2 = "IfcWindowLiningProperties.SecondTransomOffset";
         const string parameterNameV3 = "Pset_WindowLiningProperties.SecondTransomOffset";
         ...
         {
            m_SecondTransomOffset = System.Math.Clamp(value.Value, 0.0, 1.0);
            return true;
         }
