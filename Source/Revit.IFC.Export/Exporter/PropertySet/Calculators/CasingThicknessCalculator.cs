...
{
   /// <summary>
   /// A calculation class to calculate the casing thickness of a door.
   /// </summary>
   class CasingThicknessCalculator : PropertyCalculator
   {
      /// <summary>
      /// A double variable to keep the calculated value.
      /// </summary>
      private double m_CasingThickness = 0.0;

      /// <summary>
      /// The CasingThicknessCalculator instance.
      /// </summary>
      public static CasingThicknessCalculator Instance { get; } = new CasingThicknessCalculator();

      /// <summary>
      /// Calculates the casing thickness.
      /// </summary>
      ...
      {
         const string parameterNameV1 = "CasingThickness";
         const string parameterNameV2 = "IfcDoorLiningProperties.CasingThickness";
         const string parameterNameV3 = "Pset_DoorLiningProperties.CasingThickness";
         ...
         {
            m_CasingThickness = UnitUtil.ScaleLength(value);
            return true;
         }
