...
{
   /// <summary>
   /// A calculation class to calculate the transom thickness of a window or door.
   /// </summary>
   class TransomThicknessCalculator : PropertyCalculator
   {
      /// <summary>
      /// A double variable to keep the calculated value.
      /// </summary>
      private double m_TransomThickness = 0.0;

      /// <summary>
      /// The TransomThicknessCalculator instance.
      /// </summary>
      public static TransomThicknessCalculator Instance { get; } = new TransomThicknessCalculator();
      ...
      {
         // We only calculate the lining depth if the lining thickness is set.
         ...
         const string parameterNameV1 = "TransomThickness";
         string parameterNameV2 = typeName + "LiningProperties.TransomThickness";
         string parameterNameV3 = "Pset_" + baseTypeName + "LiningProperties.TransomThickness";
         ...
         m_TransomThickness = UnitUtil.ScaleLength(value.Value);
         return true;
      }
