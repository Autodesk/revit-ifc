...
{
   /// <summary>
   /// A calculation class to calculate the second mullion offset of a window.
   /// </summary>
   class SecondMullionOffsetCalculator : PropertyCalculator
   {
      /// <summary>
      /// A double variable to keep the calculated value.
      /// </summary>
      private double m_SecondMullionOffset = 0.0;

      /// <summary>
      /// The SecondMullionOffsetCalculator instance.
      /// </summary>
      public static SecondMullionOffsetCalculator Instance { get; } = new SecondMullionOffsetCalculator();
      ...
      {
         const string parameterNameV1 = "SecondMullionOffset";
         const string parameterNameV2 = "IfcWindowLiningProperties.SecondMullionOffset";
         const string parameterNameV3 = "Pset_WindowLiningProperties.SecondMullionOffset";
         ...
         {
            m_SecondMullionOffset = System.Math.Clamp(value.Value, 0.0, 1.0);
            return true;
         }
