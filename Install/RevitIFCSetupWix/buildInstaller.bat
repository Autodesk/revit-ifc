...
light.exe -ext WixUtilExtension -out RevitIFC2026.4.1.msi product.wixobj -ext WixUIExtension

copy RevitIFC2026.4.1.msi %1..\Releasex64
del RevitIFC2026.4.1.msi

echo %1..\Releasex64\RevitIFC2026.4.1.msi
