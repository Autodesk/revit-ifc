...
light.exe -ext WixUtilExtension -out RevitIFC2022.1.1.msi product.wixobj -ext WixUIExtension

copy RevitIFC2022.1.1.msi %1..\Releasex64
del RevitIFC2022.1.1.msi

echo %1..\Releasex64\RevitIFC2022.1.1.msi
