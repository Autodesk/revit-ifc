...
light.exe -ext WixUtilExtension -out RevitIFC2020.2.msi product.wixobj -ext WixUIExtension

copy RevitIFC2020.2.msi %1..\Releasex64
del RevitIFC2020.2.msi

echo %1..\Releasex64\RevitIFC2020.2.msi
