...
light.exe -ext WixUtilExtension -out RevitIFC2027.3.0.12.msi product.wixobj -ext WixUIExtension

copy RevitIFC2027.3.0.12.msi %1..\Releasex64
del RevitIFC2027.3.0.12.msi

echo %1..\Releasex64\RevitIFC2027.3.0.12.msi
