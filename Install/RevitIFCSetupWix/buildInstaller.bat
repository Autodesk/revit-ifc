...
light.exe -ext WixUtilExtension -out RevitIFC2022.6.0.msi product.wixobj -ext WixUIExtension

copy RevitIFC2022.6.0.msi %1..\Releasex64
del RevitIFC2022.6.0.msi

echo %1..\Releasex64\RevitIFC2022.6.0.msi
