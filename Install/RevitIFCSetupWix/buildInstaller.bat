...
light.exe -ext WixUtilExtension -out RevitIFC20.3.0.0.msi product.wixobj -ext WixUIExtension

copy RevitIFC20.3.0.0.msi %1..\Releasex64
del RevitIFC20.3.0.0.msi

echo %1..\Releasex64\RevitIFC20.3.0.0.msi
