...
light.exe -ext WixUtilExtension -out RevitIFC2021.4.3.msi product.wixobj -ext WixUIExtension

copy RevitIFC2021.4.3.msi %1..\Releasex64
del RevitIFC2021.4.3.msi

echo %1..\Releasex64\RevitIFC2021.4.3.msi
