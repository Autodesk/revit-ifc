...
light.exe -ext WixUtilExtension -out RevitIFC2021.4.0.msi product.wixobj -ext WixUIExtension

copy RevitIFC2021.4.0.msi %1..\Releasex64
del RevitIFC2021.4.0.msi

echo %1..\Releasex64\RevitIFC2021.4.0.msi
