...
light.exe -ext WixUtilExtension -out RevitIFC2025.4.3.msi product.wixobj -ext WixUIExtension

copy RevitIFC2025.4.3.msi %1..\Releasex64
del RevitIFC2025.4.3.msi

echo %1..\Releasex64\RevitIFC2025.4.3.msi
