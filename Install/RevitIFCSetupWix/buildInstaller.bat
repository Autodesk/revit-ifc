...
light.exe -ext WixUtilExtension -out RevitIFC2027.0.1.1.msi product.wixobj -ext WixUIExtension

copy RevitIFC2027.0.1.1.msi %1..\Releasex64
del RevitIFC2027.0.1.1.msi

echo %1..\Releasex64\RevitIFC2027.0.1.1.msi
